...
export function getWeather(cityName) {
  const response = fetch(
    `https://weather.visualcrossing.com/VisualCrossingWebServices/rest/services/timeline/${cityName}?include=fcst%2Cobs%2Chistfcst%2Cstats%2Ccurrent&key=YYXNHEGG85LVFHTTRMTML7AGY&options=beta&contentType=json`
  ).then((res) => res.json());
